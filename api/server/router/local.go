// https://github.com/moby/moby/blob/master/api/server/router/local.go
package router

import "github.com/Authoring/Graph/api/server/httputils"

// RouteWrapper wrapes a route with extra functionality
type RouteWrapper func(r Route) Route

// localRoute defines an individual api
